...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${categorys}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.parent?tpl.parent.id:0}', name:"${tpl.categoryName}", url:"${ctx}/business/comsume/mx/list?category=${tpl.categoryName}&code=${tpl.categoryCode}", target:"comsumeMainFrame"},
		            </c:forEach>];
